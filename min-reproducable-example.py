...
class EarlyStoppingPlugin(StrategyPlugin):
    ...
    def before_training_epoch(self, strategy, **kwargs):
        if self.peval_mode == "epoch":
            ...
            print(
                f'Current step: {curr_step}, current val metric: {strategy.evaluator.get_last_metrics().get(self.metric_key)}')
...
experience_2_train_x = torch.zeros(80, *pattern_shape)
experience_2_train_y = torch.zeros(80, *pattern_shape)
